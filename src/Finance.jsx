    ...
    <div className="finance-component-container"> {/* Fix class name here */}
      <section className="hero">
        <div className="hero-content">
          <div className="section-title">
            <h1 className='dummy'>Finance Solutions</h1>
          </div>
        ...
        <div className="card">
          ...
          <div className="client-spotlight-list">
            <div className="client-spotlight-item card">
              <h3>Transforming Financial Operations</h3>
              <p>
            ...
            <div className="client-spotlight-item card">
              <h3>Revolutionizing the Finance Landscape</h3>
              <p>
      ...
      <section className="section-cta">
        <div className="cta-content">
          <h2>Ready to Elevate Your Financial Business?</h2>
          <p>
