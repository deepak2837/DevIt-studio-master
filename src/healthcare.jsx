  ...
  return (
    <div className="healthcare-software-component-container">
      ...
      <section className="section-card">
        <div className="card">
          <h2>Our Healthcare Software Development Services</h2>
      ...
      <section className="section-card">
        <div className="card">
          <h2>Healthcare Solutions We Develop</h2>
